...
<link rel="stylesheet" href="{{ asset('be/dist/assets/css/dataTables.bootstrap4.css') }}">
<link rel="stylesheet" href="{{ asset('be/dist/assets/css/responsive.bootstrap4.css') }}">
