...
<script src="{{ asset('be/dist/assets/js/jquery.dataTables.js') }}"></script>
<script src="{{ asset('be/dist/assets/js/dataTables.bootstrap4.js') }}"></script>
<script src="{{ asset('be/dist/assets/js/dataTables.responsive.js') }}"></script>
<script src="{{ asset('be/dist/assets/js/responsive.bootstrap4.js') }}"></script>

<script src="{{ asset('be/dist/assets/js/sweetalert2.js') }}"></script>
